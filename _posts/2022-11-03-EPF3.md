...
<span style="color:grey">(This is an update on my [Ethereum Protocol Fellowship]({% post_url 2022-10-18-EPF0 %}). Earlier updates can be found [here]({% post_url 2022-10-25-EPF1 %}) ).</span>
...
4. A next player gets to choose one of BigPlayer's pieces. 
...
The structure of the game is then very similar to the previously covered [sequential decision games]({% post_url 2022-10-25-EPF2 %}). 
